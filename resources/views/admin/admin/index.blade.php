    ...
    <script>
        new Vue({
            ...
            created:function(){
                ...
                this.tableData = admins.data;
                this.total = admins.total;
                this.per_page = parseInt(admins.per_page);
            },
            methods:{
                getLogList: function (pTo) {
                    ...
                    axios.get('/admin/admins' + param).then(function (re) {
                ...
                handleDelete: function (index, row) {
                    var that =this;
                    axios.delete('/admin/admins/'+row.id).then(function(re){
                        that.$message({
                            message: '删除成功',
                            type: 'success'
                        });
                ...
                change: function (r, x,f) {
                    var that = this;
                    axios.get('/admin/admins/'+r.id+'/'+r[x]+'/'+f).then(function(){
                        that.$message({
                            message: '操作成功',
                            type: 'success'
                        })
